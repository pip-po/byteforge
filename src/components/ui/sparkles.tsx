...
// Move options configuration outside of component to avoid recreation on each render
const createParticlesOptions = (props: ParticlesProps): ISourceOptions => {
  const {
    background = "#0d47a1",
    minSize = 1,
    maxSize = 3,
